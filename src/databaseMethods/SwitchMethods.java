...
public class SwitchMethods extends Model {
	...
	/**
	 * Model til � slette kalender hvis den eksisterer samt at det 
	 * gj�res av den samme bruker som har laget den.
	 * @param userName
	 * @param calendarName
	 * @return String
	 * @throws SQLException
	...
	/**
	 * Henter alle kalendere som tilh�rer den valgte bruker
	 * @param email
	 * @return String
	 * @throws SQLException
	 */
	...
	/**
	 * Bruker metode CreateNote fra klasse Note til � opprette en note
	 * p� bakgrunn av Jsonclass CreateNote
	 * @param cn
	 * @return
	 */
	...
	/**
	 * Model til � slette event fra database hvis det enten gj�res av 
	...
	/**
	 * Metode til � slette en note. Det blir kun slettet hvis det
	...
	/**
	 * Henter events fra systemet p� bakgrunn av calendarId
	 * @param calendarID
	 * @return String
	 * @throws SQLException
	 */
	...
	/**
	 * Henter noter fra databasen basert p� eventID
	 * @param events
	 * @return String
	 * @throws SQLException
	 */
	...
	/**
	 * Metode til � logge bruker inn i systemet, 

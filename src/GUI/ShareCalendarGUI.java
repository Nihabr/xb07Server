	...
	public ShareCalendarGUI() {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				calendarID= table.getValueAt(row, 0).toString();
				textFieldChooseCal.setText(calendarID);
		...
		lblShareWith.setBounds(433, 571, 159, 31);
		add(lblShareWith);
		...
		lblChooseCalendarBy.setBounds(298, 527, 294, 31);
